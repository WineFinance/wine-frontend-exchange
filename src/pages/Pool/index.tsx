          ...
          <CardBody>
            <AutoColumn gap="12px" style={{ width: '100%' }}>
              ...
              <div>
                ...
                <Text fontSize="14px" style={{ padding: '.5rem 0 .5rem 0' }}>
                Cannot see the pool you provided? Try to add manually by clicking
                <Text fontSize="24px" style={{ textDecorationLine: 'underline', color: 'cyan' }}> <Link to="/find">HERE.</Link></Text>
                </Text>
                <Text fontSize="14px" style={{ padding: '.5rem 0 .5rem 0' }}>
